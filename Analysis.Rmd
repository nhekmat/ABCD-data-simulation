...
# Moderating effect of heat for model 1 only for sex
...
F_to_eta2(4.2976,1,750.21) #very small effect when looking at  f value of days of 90 site from anova
...
F_to_eta2(4.3165 ,1,675.96) #very small effect when looking at  f value of days of 90 site from anova
...
```
 ...
 # Below is just testing for model 2 which includes the moderating effect of heat on all covariates? Unsure how to interpret
